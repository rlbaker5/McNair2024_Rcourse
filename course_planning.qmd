...
(Rob takes lead on Prep as Clay has interview prep to do) 10 min: Intro to Rob and Clay (10 minutes max) 15 min: Intro to the seminar (purpose, where to find course materials, office hours for extra help, etc) 20 min: What is CS? What is a programming language? Why use it? \* reproducibility, transparency, sharing/collaborating, publishing 10-15 min: Examples: ideas in hmanities context?
